...
DeadReckoning::DeadReckoning(volatile unsigned int *left, volatile unsigned int *right, double tpr, double r, double l) {
    leftTicks = left;
    rightTicks = right;
    ticksPerRev = tpr;
    radius = r;
...
double DeadReckoning::getX() {
    return xc;
}

double DeadReckoning::getY() {
    return yc;
}

double DeadReckoning::getWl() {
    return wl;
}

double DeadReckoning::getWr() {
    return wr;
}

double DeadReckoning::getTheta() {
    return theta;
}
...
void DeadReckoning::computeAngularVelocities() {
...
void DeadReckoning::computePosition() {
