...
void Motor::moveFast(int direction, int speedLeft, int speedRight) {
    switch (direction) {
        case FORWARD:
            forward(speedLeft, speedRight);
            break;
        case REVERSE:
            ...
            break;
        case LEFT:
            turnLeftFast(speedRight);
            break;
        case RIGHT:
            turnRightFast(speedLeft);
            break;
    }
}
...
void Motor::turnLeftFast(int speedRight) {
    int speedLeft = 0;
    setSpeed(speedLeft, speedRight);
...
void Motor::turnRightFast(int speedLeft) {
    int speedRight = 0;
    setSpeed(speedLeft, speedRight);
