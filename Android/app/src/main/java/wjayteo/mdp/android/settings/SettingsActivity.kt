...
import wjayteo.mdp.android.App.Companion.GOAL_POINT_COMMAND
...
import wjayteo.mdp.android.App.Companion.START_POINT_COMMAND
...
import wjayteo.mdp.android.databinding.ActivitySettingsBinding
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            ...
            10001 -> {
                ...
                PC_PREFIX = getString(R.string.pc_prefix_default)
                ...
                sharedPreferences.edit().putString(getString(R.string.app_pref_pc_prefix), PC_PREFIX).apply()
            ...
            10002 -> {
                ...
                EXPLORATION_COMMAND = getString(R.string.exploration_default)
                FASTEST_PATH_COMMAND = getString(R.string.fastest_path_default)

                sharedPreferences.edit().putString(getString(R.string.app_pref_send_arena), SEND_ARENA_COMMAND).apply()
                sharedPreferences.edit().putString(getString(R.string.app_pref_exploration), EXPLORATION_COMMAND).apply()
                sharedPreferences.edit().putString(getString(R.string.app_pref_fastest), FASTEST_PATH_COMMAND).apply()
